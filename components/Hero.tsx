...
const Hero = () => {
    return (
        <section className="w-full h-full flex flex-col justify-center items-start p-10">
            ...
            <p className="mt-4 max-w-fit text-lg text-[var(--muted-foreground) md:pe-2 md:overflow-hidden md:border-r-4 md:border-r-primary md:animate-typing md:whitespace-nowrap md:tracking-[.15em]">Front-End Developer | Next.js & Tailwind Enthusiast</p>
            <div className="mt-6">
                <Button
